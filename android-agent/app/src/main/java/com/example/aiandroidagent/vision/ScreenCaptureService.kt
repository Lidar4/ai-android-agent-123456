...
class ScreenCaptureManager { var projection:MediaProjection?=null; var authorized=false; fun setMediaProjection(value:MediaProjection){projection=value;authorized=true}; fun release(){projection?.stop();projection=null;authorized=false} }
